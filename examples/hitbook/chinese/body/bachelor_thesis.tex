...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.7\textwidth]{fig1-Supervised Registration-crop.pdf}
    \caption{有监督配准模型}
    \label{fig:1}
\end{figure}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.7\textwidth]{fig7-unsupervised Registration-crop.pdf}
    \caption{无监督配准模型}
    \label{fig:7}
\end{figure}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.7\textwidth]{c2-markedimg.png}
    \caption{带分割标签的可视化图像}
    \label{fig:c2-4}
\end{figure}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.6\textwidth]{cst-crop.pdf}
    \caption{Dice系数随训练epoch的变化曲线}
    \label{fig:cstloss}
\end{figure}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.7\textwidth]{fig2-mutualreg-crop.pdf}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.7\textwidth]{fig3-vrc-crop.pdf}
