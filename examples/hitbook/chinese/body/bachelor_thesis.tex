...
\begin{figure}[h]
    \centering
    \subfigure[浮动图像差分图]{\label{fig:c2-5}
        \begin{minipage}{0.4\textwidth}
        \includegraphics[width=\textwidth]{c2-imgdiff1.png}
        
    \end{minipage}
    }
    \subfigure[配准后图像差分图]{\label{fig:c2-6}
        \begin{minipage}{0.4\textwidth}
